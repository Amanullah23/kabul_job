  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-8">
      ...
      <div className="flex items-center border-b md:border-b-0 border-gray-200 dark:border-gray-700 px-4 sm:py-6 py-3 w-full md:w-1/2">
        ...
        <input type="text" placeholder="City or post code " className="w-full outline-none"/>
      </div>
      <button className="bg-blue-600 text-white ox-8 sm:py-6 py-3 cursor-pointer text-sm md:text-base w-full md:w-auto min-w-[140px] whitespace-normal hover:bg-blue-700 transition">Find Jobs</button>
      </div>
    </div>
  );
};

...
const categoryData = [
  ...
  {
    id: 6,
    categoryName: "Customer Services",
    openPositions: 2,
    icon: (
...
const Category = () => {
  return (
    <div className="pt-16 pb-16">
      ...
      />
      <div
        className="w-[80%] mx-auto mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3
        ...
        {categoryData.map((category, index) => {
          return (
            <div
              key={category.id}
              data-aos="fade-right"
              data-aos-acchor-placement="top-center"
